...
>>>>>>> 8d3a45f4698f5fe173105aaadf6870406dc882c0
        ...
        <div className="bio-container">
          ...
          <div className="about-row-reverse">
            ...
            <div className="bio-p-1">
              <h3 className="med-text">
                ...
                Michoacan, Mexico. I come from a working people, and have always
                been fascinated with using my hands to create. In recent years
                this passion has shifted towards a digital medium. Whether it is
                programming, design, music production, or digital art, I am
                fixated on bringing ideas to life to be enjoyed by a global
                audience.
              </h3>
            </div>
          </div>
          ...
          <div className="about-row extra-space-bottom">
            ...
            <div className="bio-p-2">
              <p className="sm-text">
                I received a Bachelors of Arts degree in Data Science with an
                emphasis in Cognition from the University of California,
                Berkeley in 2020. I have expanded upon the fundamentals of
                programming and statistics earned through the nation's #1
                program, and incorporated that knowledge with my love of digital
                media which has led me to my current trajectory as a Front-End
                Software Engineer. I specialize in end-to-end product
                development, branding, and overthinking. Hit me up if you would
                like to collaborate, I am always open to making new friends.
              </p>
            </div>
          </div>
        </div>
